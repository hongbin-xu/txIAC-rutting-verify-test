...
if check_password():    
    ...
    with col1:
        with st.container():
            ...
            with col11:
                idmin = st.number_input(min_value=1, max_value=90000-1, value = 1, step= 1)
            with col12:
                idmax = st.number_input(min_value=idmin, max_value=min(90000, idmin + 4499), value = idmin+50, step= 1)
            # Load data
